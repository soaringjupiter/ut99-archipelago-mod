...
defaultproperties
{
     ...
     RankedGame(5)=5
     RankedGame(6)=6
     MatchInfo(0)="Archipelago.APRatedMatchASTUT"
     MatchInfo(1)="Archipelago.APRatedMatchAS1"
     MatchInfo(2)="Archipelago.APRatedMatchAS2"
     MatchInfo(3)="Archipelago.APRatedMatchAS3"
     MatchInfo(4)="Archipelago.APRatedMatchAS4"
     MatchInfo(5)="Archipelago.APRatedMatchAS5"
     MatchInfo(6)="Archipelago.APRatedMatchAS6"
}
