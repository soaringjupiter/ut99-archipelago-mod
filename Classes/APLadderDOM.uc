...
defaultproperties
{
     ...
     GoalTeamScore(8)=175
     GoalTeamScore(9)=200
     MatchInfo(0)="Archipelago.APRatedMatchDOMTUT"
     MatchInfo(1)="Archipelago.APRatedMatchDOM1"
     MatchInfo(2)="Archipelago.APRatedMatchDOM3"
     MatchInfo(3)="Archipelago.APRatedMatchDOM4"
     MatchInfo(4)="Archipelago.APRatedMatchDOM5"
     MatchInfo(5)="Archipelago.APRatedMatchDOM6"
     MatchInfo(6)="Archipelago.APRatedMatchDOM7"
     MatchInfo(7)="Archipelago.APRatedMatchDOM8"
     MatchInfo(8)="Archipelago.APRatedMatchDOM9"
     MatchInfo(9)="Archipelago.APRatedMatchDOM10"
}
